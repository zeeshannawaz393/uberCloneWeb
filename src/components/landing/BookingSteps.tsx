/**
 * Booking Steps - Pixel Perfect
 * Exact replica of 3-step booking process with vertical timeline
 */
    ...
    return (
        <section className="bg-white py-20">
            <div className="max-w-[1280px] mx-auto px-4 lg:px-16">
                {/* Section Heading */}
                <h2 className="text-[36px] leading-[44px] font-bold tracking-tight mb-20 text-black">
                ...
                <div className="relative">
                    ...
                    <div className="space-y-24">
                        {steps.map((step, index) => (
                            <div key={index} className="grid lg:grid-cols-[1fr_auto_1fr] gap-12 items-start">
                                {/* Image (Left) */}
                                <div className="relative h-[200px] w-full max-w-[350px] mx-auto lg:mx-0">
                                ...
                                {/* Content (Right) */}
                                <div className="pt-0 max-w-[400px]">
                                    <h3 className="text-[18px] leading-[24px] font-bold mb-2 text-black">
                                        {step.title}
                                    </h3>
                                    <p className="text-[16px] leading-[24px] text-gray-600 font-normal">
                                        {step.description}
                                    </p>
                                    {step.note && (
                                        <p className="text-[16px] text-black underline mt-4 cursor-pointer hover:text-gray-600">
                                            {step.note}
                                        </p>
                                    )}
                                </div>
