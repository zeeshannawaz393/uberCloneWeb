/**
 * Ride Options - Pixel Perfect
 * Exact replica of "Ways to ride and more" section
 */
    ...
    return (
        <section className="bg-white py-20">
            <div className="max-w-[1280px] mx-auto px-4 lg:px-16">
                {/* Section Heading */}
                <h2 className="text-[36px] leading-[44px] font-bold tracking-tight mb-12 text-black">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    {/* Reserve Card */}
                    <div className="bg-[#F3F3F3] rounded-xl p-8 flex justify-between items-center h-[240px] relative overflow-hidden group cursor-pointer">
                        <div className="z-10 flex flex-col justify-between h-full items-start">
                            <div>
                                <h3 className="text-[24px] font-bold mb-2 text-black">Reserve</h3>
                                <p className="text-[16px] text-black max-w-[200px]">
                                    Reserve your ride in advance so you can relax on the day of your trip.
                                </p>
                            </div>
                            <button className="bg-white text-black px-5 py-2 rounded-full text-[14px] font-medium shadow-sm hover:bg-gray-50 transition-colors mt-4">
                                Details
                            </button>
                        </div>
                    ...
                    <div className="bg-[#F3F3F3] rounded-xl p-8 flex justify-between items-center h-[240px] relative overflow-hidden group cursor-pointer">
                        <div className="z-10 flex flex-col justify-between h-full items-start">
                            <div>
                                <h3 className="text-[24px] font-bold mb-2 text-black">Ride</h3>
                                <p className="text-[16px] text-black max-w-[200px]">
