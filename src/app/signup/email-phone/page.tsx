/**
 * Screen 1: Enter Phone Number or Email - Responsive
...
export default function EmailPhonePage() {
    ...
    return (
        <div className="bg-white rounded-lg p-5 sm:p-8 md:p-12 shadow-sm">
            ...
            {/* Continue Button - Consistent Height */}
            <button
            ...
            {/* Social Login Buttons - Consistent Height */}
            <button
            ...
            {/* QR Code Login - Consistent Height */}
